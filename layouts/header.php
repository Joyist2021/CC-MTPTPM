...
<body>
         <section class="header">
                <div class="container">
                    <div class="header-search">
                        <div>
                            <a href="index.php" class="fas fa-store-alt" style="color:white;font-weight:bold"> Zphone</a>
                        </div>
             ...
             <section class = "sliderbar" style="margin-top: 20px;">
    <div class="container">
    <div class="row">
       <div class="col-md-8">
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
             <div class="carousel-inner">
                ...
                <img class="d-block w-100" src="./public/frontend/img/S21-800-300-800x300-2.png?>" alt="First slide">
                </div>
                <div class="carousel-item">
                <img class="d-block w-100" src="./public/frontend/img/800-300-800x300-31.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                <img class="d-block w-100" src="./public/frontend/img/800-300-800x300-7.png" alt="Third slide">
                </div>
            </div>
    ...
    <div class="col-md-4">
        <div class="top">
            <img src="./public/frontend/img/398-110-398x110.png" style="height: 140px; width: 380px" alt="">
        </div>

        <div class="bottom">
            <img src="./public/frontend/img/398-110-398x110-2.png" style="height: 150px; width: 380px" alt="">
        </div>
    </div>
    </div>
    </div>   
